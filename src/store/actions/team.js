...
export function onTeamNotificationMsg({
    state,
    commit
}, msg) {
...
export function enterSettingPage({
    commit
}, obj) {
 ...
 * @options 传递给sdk方法的参数
 */
export function delegateTeamFunction({
    state
}, {
    functionName,
    options
...
export function checkTeamMsgReceipt({
    state
}, msgs) {
...
export function getTeamMsgReads({
    state
}, needQuery) {
    nim.getTeamMsgReads({
